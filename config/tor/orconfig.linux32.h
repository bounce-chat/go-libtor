...
#define CONFIG_FLAGS "--disable-shared --enable-static --disable-seccomp --disable-libscrypt --disable-lzma --disable-zstd --disable-systemd --disable-asciidoc --disable-unittests"
